...
export function PricingCard({
    ...
    return (
        <div className={`bg-white rounded-xl shadow-sm p-6 relative overflow-hidden flex flex-col ${isPopular ? 'border border-[#262ef2]/20 shadow-[#262ef2]/5 shadow-xl' : 'border border-[#e3e3e3]'}`}>
            {isPopular && (
            ...
            <button
                ...
                className={`text-sm font-medium mt-6 w-full py-2.5 rounded-lg transition-all ${isDisabled ? 'opacity-50 cursor-not-allowed bg-[#f3f3f9] text-[#a1a1a1] border border-[#e3e3e3]' : (isPopular ? 'text-white shadow-lg shadow-[#262ef2]/20 hover:-translate-y-0.5' : 'bg-white border border-[#e3e3e3] text-[#4d5564] hover:bg-[#f3f3f9] shadow-sm hover:-translate-y-0.5')}`}

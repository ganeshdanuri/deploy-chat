...
export default function ChatbotsPage() {
    ...
    const ChatbotCard = ({ bot }: { bot: Chatbot }) => {
        ...
        return (
            <div className="bg-white rounded-xl border border-slate-100 p-5 hover:border-indigo-200 hover:shadow-xl hover:shadow-indigo-500/5 transition-all group relative animate-fade-in">
                <div className="flex justify-between items-start mb-4">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-indigo-50/50 to-slate-50 border border-slate-100 flex items-center justify-center text-indigo-600 shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-2 mt-auto">
                    ...
                    <Button
                        ...
                        className="bg-white text-slate-600 text-[11px] font-bold rounded-lg hover:bg-slate-50 transition-all shadow-sm border border-slate-100 py-5"
                    >

...
import { HiDatabase, HiPlus, HiSearch, HiRefresh, HiCheck, HiExclamation, HiCollection } from "react-icons/hi";
        ...
        <div className="space-y-6 animate-fade-in-up">
            ...
            {!hasDatasets ? (
                ...
                <div className="flex flex-col items-center justify-center py-20 bg-white rounded-2xl border-2 border-dashed border-slate-200">
                    ...
                    <button className="px-6 py-3 bg-emerald-600 text-white text-sm font-bold rounded-xl shadow-lg shadow-emerald-200 hover:bg-emerald-700 hover:-translate-y-0.5 transition-all flex items-center gap-2">

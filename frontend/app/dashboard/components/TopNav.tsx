    ...
    return (
        <header className="h-16 bg-white border-b border-slate-100 flex items-center justify-between px-4 sm:px-6 sticky top-0 z-30">
            ...
            <div className="flex-1 max-w-2xl flex items-center gap-2 sm:gap-4">
                ...
                <div className="relative w-full max-w-md group hidden sm:block">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 bg-slate-50 border border-slate-100 rounded-xl text-sm text-slate-600 placeholder:text-slate-400 focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-medium"
                    />
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 flex gap-1">
                        <span className="text-[10px] font-bold text-slate-400 bg-white border border-slate-100 rounded px-1.5 py-0.5 shadow-sm">⌘</span>
                        <span className="text-[10px] font-bold text-slate-400 bg-white border border-slate-100 rounded px-1.5 py-0.5 shadow-sm">K</span>
                    </div>
                </div>
            </div>
            ...
            <div className="flex items-center gap-1 sm:gap-2">
                ...
                <div className="flex items-center gap-1 border-r border-slate-100 pr-2 sm:pr-3 mr-2 sm:mr-3">
                    <div className="hidden md:flex items-center px-2 py-1 rounded-md bg-slate-100 border border-slate-100 mr-2">
